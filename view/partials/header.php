...
<head>
  ...
  <!-- Fontawesome -->
  <script src="https://kit.fontawesome.com/b8535d87fa.js" crossorigin="anonymous"></script>
  ...
  <!-- Static Content -->
  <link rel="stylesheet" href="/reservas-app/static/css/index.css" />
  <?php $uri = parse_url($_SERVER["REQUEST_URI"], PHP_URL_PATH) ?>
  <?php if ($uri == "/reservas-app/" || $uri == "/reservas-app/index.php") : ?>
